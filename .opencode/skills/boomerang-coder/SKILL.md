...
#### When Saving:
- **Routine work** (error logs, quick fixes, chat turns): Use standard `super-memory_save_to_memory`
- **High-value work** (verified bug fixes, established patterns, architectural decisions): Use `boomerang_memory_save_long` with a descriptive `project` tag
